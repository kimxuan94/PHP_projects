<?php
	...
	?>
	<form method="post" action="maj2_collaborateur.php" enctype="multipart/form-data">
	  <div class="form-group">
	    <label for="idmatrh">ID RH</label>
	    <input type="text" class="form-control" id="idmatrh" name="idmatrh" value='<?php echo $collaborateur->idmatrh; ?>'>
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <select class="form-control" id="sel1" name="profession" value=''>
	      <option><?php echo $collaborateur->profession; ?></option>
	      <option>ARS</option>
	      <option>APM</option>
	    </select>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="avantage" name="avanatage" value='<?php echo $collaborateur->avantage; ?>'>
	  </div>
